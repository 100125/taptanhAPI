...
using taptanhAPI.Models;

namespace taptanhAPI.Controllers
{
    ...
    public class RegistrationController : ControllerBase
    {
        ...
        {
            SqlConnection con = new SqlConnection(_configuration.GetConnectionString("ToysCon").ToString());
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM Registration WHERE Email= '"+registration.Email+ "'AND UserName= '"+registration.UserName+"'AND Password= '" + registration.Password+"'AND IsActive=1", con);
